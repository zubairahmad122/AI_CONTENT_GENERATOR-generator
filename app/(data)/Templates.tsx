export default  [
    {
        name: 'LinkedIn Job Post',
        desc: 'An AI tool that generates LinkedIn job posts based on your job information.',
        category: 'Job',
        icon: 'https://cdn-icons-png.flaticon.com/128/3536/3536505.png',
        aiPrompt: 'Provide 5 job posts in bullet points based on the given niche and outline. Output should be in Rich Text Editor format.',
        slug: 'generate-linkedin-job-post',
        form: [
            {
                label: 'Enter your Job information',
                field: 'input',
                name: 'niche',
                required: true
            },
            {
                label: 'Enter job outline',
                field: 'textarea',
                name: 'outline'
            }
        ]
